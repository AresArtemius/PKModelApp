-- Subscription plans, account entitlements, and first monetization limits.
-- Run after roles_and_agent_approval.sql and selections_rpc.sql.
-- Stripe/RevenueCat webhooks should upsert user_billing_profiles with service role.
