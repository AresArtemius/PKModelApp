...
- [x] Добавить публичные стандарты безопасности детей для Google Play: `https://app.pk.management/#/child-safety`, встроенный канал жалоб по категории «Безопасность» и контакт `artem@president-kids.ru`.
